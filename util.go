...
func SterilizeFilename(s string, underscore bool) string {
...
func FormatFilename(format string, vals map[string]string, underscore bool) (string, error) {
	...
	for k, v := range vals {
		...
		fnameVals[k] = SterilizeFilename(v, underscore)
	}
